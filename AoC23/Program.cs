...
Console.WriteLine($"Day #2 - Part 2 - {AoC23.Day02.Solution.GetResult_Part2(File.ReadAllLines("Input/02.txt"))}");

Console.WriteLine($"Day #4 - Part 1 - {AoC23.Day04.Solution.GetResult_Part1(File.ReadAllLines("Input/04.txt"))}");
